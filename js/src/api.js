...
function fourSquareInfo () {
  ...
  var fourSquareUrl = 'https://api.foursquare.com/v2/venues/search?ll=42.2409745,-83.7698831&client_id='+ clientID +'&client_secret=' + clientSecret + '&v=20170215&query=pita-pita-mediterranean-grill&limit=1';
  $.ajax({
      url: fourSquareUrl,
       dataType: "jsonp",
           ...
           console.log(date);
            ...
            console.log('Failed To Get Foursquare');
        });
}
fourSquareInfo();
